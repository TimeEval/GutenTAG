...
class Compatibility:
    combinations = pd.DataFrame(
        [
            [1, 1, 1, 1, 1, 0, 0, 0],  # amplitude
            [1, 1, 1, 1, 1, 1, 0, 1],  # extremum
            [1, 1, 0, 0, 1, 0, 0, 0],  # frequency
            [1, 1, 1, 1, 1, 1, 0, 1],  # mean
            [1, 1, 0, 1, 1, 0, 0, 0],  # pattern
            [1, 1, 0, 0, 1, 0, 0, 0],  # pattern_shift
            [1, 1, 1, 1, 1, 1, 0, 1],  # platform
            [1, 1, 1, 1, 1, 1, 0, 1],  # trend
            [1, 1, 1, 1, 1, 1, 0, 1],  # variance
            [0, 0, 0, 0, 0, 0, 1, 0],  # mode_correlation
        ],
        columns=[BASE_OSCILLATION_NAMES.SINE, BASE_OSCILLATION_NAMES.COSINE, BASE_OSCILLATION_NAMES.RANDOM_WALK,
                 BASE_OSCILLATION_NAMES.CYLINDER_BELL_FUNNEL, BASE_OSCILLATION_NAMES.ECG,
                 BASE_OSCILLATION_NAMES.POLYNOMIAL, BASE_OSCILLATION_NAMES.RANDOM_MODE_JUMP,
