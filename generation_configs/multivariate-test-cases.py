...
def random_bo(kind: str):
    ...
    mapping = {
        ...
        "complex-sine": {
            ...
            "amplitude": np.random.rand() * 10,
            "freq-mod": 0.01,
            "trend": {"kind": "polynomial", "polynomial": [1, 1]},
        },
        "ecg": {
            "kind": "ecg",
...
def random_anomaly(kind: str):
    trend_bos = [
        {"kind": "polynomial", "polynomial": [2, 2]},
        {"kind": "polynomial", "polynomial": [0.2, 0.2]},
        {"kind": "sine", "frequency": 0.725, "amplitude": 0.25, "variance": 0.0},
        {"kind": "sine", "frequency": 1, "amplitude": 0.5, "variance": 0.0},
    ]
    mapping = {
        "amplitude": {
            "kind": "amplitude",
        ...
        "mean": {"kind": "mean", "offset": np.random.rand() * 20 - 10},
        "pattern": {
            "kind": "pattern",
        ...
        "platform": {"kind": "platform", "value": np.random.randint(10)},
        "trend": {"kind": "trend", "oscillation": np.random.choice(trend_bos)},
        "variance": {"kind": "variance", "variance": np.random.rand() / 2},
        "mode-correlation": {"kind": "mode-correlation"},
    }
    return mapping[kind]
...
def gen_bo_diversity_series():
    ...
    # multiple diff
    n_bos = 10
    times_mapping = {2: [5, 5], 3: [3, 3, 4], 4: [2, 2, 3, 3], 5: [2, 2, 2, 2, 2]}
    for i in [2, 3, 4, 5]:
        ...
        for anom_tuple in anom_combs:
            ...
            for n in [2, 3, 5, 10, n_bos]:
                ...
                for anom, anom_times in zip(anom_tuple, times):
                    anom_channels = np.random.choice(
                        n_bos, size=anom_times, replace=False
                    )
                    for c in anom_channels:
                        anomaly_defs.append(
                            {
    ...
    return [
        {
            ...
            "supervised": GENERATE_SUPERVISED,
            "base-oscillations": [
                {"kind": "sine", "frequency": 0.5, "offset": 2},
                {
                    "kind": "formula",
                    "formula": {"base": 0, "operation": {"kind": "*", "operand": -1.0}},
                },
            ],
            "anomalies": [
                {
        ...
        },
        {
            ...
            "base-oscillations": [
                ...
                {"kind": "ecg", "frequency": 2, "variance": 0.005},
            ],
            "anomalies": [
                {
                    "position": "middle",
                ...
                },
                {
                    ...
                    "creeping-length": 250,
                    "channel": 0,
                    "kinds": [{"kind": "variance", "variance": 0.5}],
                },
                {
                    "position": "end",
                    "length": 200,
        ...
        },
        {
            ...
            "anomalies": [
                ...
                },
                {
                    ...
                    "length": 200,
                    "channel": 2,
                    "kinds": [{"kind": "frequency", "frequency_factor": 0.5}],
                },
            ],
        },
        {
            ...
            "supervised": GENERATE_SUPERVISED,
            "base-oscillations": [
                {"kind": "ecg", "frequency": 1, "offset": 0, "variance": 0.001}
            ],
            "anomalies": [
                {
                    "exact-position": 1715,
        ...
        },
        {
            ...
            "supervised": GENERATE_SUPERVISED,
            "base-oscillations": [
                {"kind": "sine", "frequency": 0.25, "offset": 0, "variance": 0},
                {"kind": "ecg", "frequency": 1, "offset": 0, "variance": 0},
                {
                    "kind": "formula",
                    "formula": {
                        "base": 0,
...
if __name__ == "__main__":
    ...
    config = {
        "timeseries": gen_channel_series()
        + gen_bo_diversity_series()
        + gen_anomaly_appearance_series()
        + gen_special_series()
    }
    gutentag = GutenTAG(
        n_jobs=-1, seed=SEED, addons=["gutenTAG.addons.timeeval.TimeEvalAddOn"]
    )
