...
class TestIntegrationAnomalyTypes(TestIntegration):
    def test_pattern_sinusoid_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-pattern.yaml",
    ...
    def test_extremum_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-extremum.yaml",
    ...
    def test_amplitude_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-amplitude.yaml",
    ...
    def test_trend_anomaly_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-trend-anomaly.yaml",
    ...
    def test_creeping_amplitude_anomaly_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-creeping-amplitude.yaml",
    ...
    def test_creeping_mean_anomaly_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-creeping-mean.yaml",
    ...
    def test_creeping_variance_anomaly_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-creeping-variance.yaml",
    ...
    def test_creeping_variance_transition_anomaly_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-creeping-variance-transition.yaml",
