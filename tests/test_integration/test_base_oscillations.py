...
class TestIntegrationBaseOscillations(TestIntegration):
    def test_generates_single_channel(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-single.yaml",
    ...
    def test_generates_single_channel_bo_list(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-single-element.yaml",
            "tests/generated/example-ts-single.csv",
            ["value-0", "is_anomaly"],
        )
    ...
    def test_generates_multi_channel(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-multi.yaml",
    ...
    def test_generates_multi_channel_bo_list(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-multi-element.yaml",
            "tests/generated/example-ts-multi.csv",
            ["value-0", "value-1", "is_anomaly"],
        )
    ...
    def test_rmj_bo_list(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-rmj.yaml",
    ...
    def test_custom_input_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-custom-input.yaml",
    ...
    def test_cbf_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-cbf.yaml",
    ...
    def test_rw_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-rw.yaml",
    ...
    def test_ecg_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-ecg.yaml",
    ...
    def test_polynomial_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-polynomial.yaml",
    ...
    def test_trend_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-trend.yaml",
            "tests/generated/example-ts-trend.csv",
            ["value-0", "is_anomaly"],
        )

    def test_nested_trend_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-nested-trend.yaml",
            "tests/generated/example-ts-nested-trend.csv",
            ["value-0", "is_anomaly"],
        )

    def test_formula_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-formula.yaml",
    ...
    def test_cosine_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-cosine.yaml",
    ...
    def test_square_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-square.yaml",
    ...
    def test_sawtooth_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-sawtooth.yaml",
            "tests/generated/example-ts-sawtooth.csv",
            ["value-0", "is_anomaly"],
        )

    def test_dirichlet_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-dirichlet.yaml",
    ...
    def test_mls_from_config(self):
        self._compare_expected_and_generated(
            "tests/configs/example-config-mls.yaml",
