...
![python version 3.9|3.10|3.11](https://img.shields.io/badge/python-3.9%20%7C%203.10%20%7C%203.11-blue)
...
1. Install GutenTAG from [PyPI](https://pypi.org/project/timeeval-gutenTAG/):
   ...
   GutenTAG supports Python 3.9, 3.10, and 3.11; all other [requirements](./requirements.txt) are installed with the pip-call above.
